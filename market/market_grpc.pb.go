...
type MarketClient interface {
	...
	RegisterFile(ctx context.Context, in *RegisterFileRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *marketClient) RegisterFile(ctx context.Context, in *RegisterFileRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type MarketServer interface {
	// register a file on the market
	RegisterFile(context.Context, *RegisterFileRequest) (*empty.Empty, error)
	// check for holders of a file. returns a list of users
...
func (UnimplementedMarketServer) RegisterFile(context.Context, *RegisterFileRequest) (*empty.Empty, error) {
